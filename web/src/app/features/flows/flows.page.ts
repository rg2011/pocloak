      ...
      <div class="content" *ngIf="activeTab() === 'spa-pkce-flow'">
        ...
        <div class="mt-4">
          ...
          <ul>
            ...
            <li>This tab is conceptual for teaching PKCE public-client flow; this POC runtime still uses BFF architecture.</li>
          </ul>
        </div>
      </div>
    </article>
...
export class FlowsPageComponent {
  readonly activeTab = signal<'login-flow' | 'access-flow' | 'spa-pkce-flow'>('login-flow');
